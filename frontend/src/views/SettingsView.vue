...
const form = reactive({
  enabled_scrapers: ['anidb', 'dmm', 'getchu'],
  anidb_client: '',
  anidb_clientver: 1,
  dmm_api_id: '',
  dmm_affiliate_id: '',
    ...
    <div class="setting-grid">
      <el-form label-position="top">
        <el-form-item label="启用的爬虫">
          <el-checkbox-group v-model="form.enabled_scrapers">
            <el-checkbox value="anidb">AniDB</el-checkbox>
            <el-checkbox value="dmm">DMM / FANZA</el-checkbox>
            <el-checkbox value="getchu">Getchu</el-checkbox>
          </el-checkbox-group>
          <p class="setting-help">停用后，该来源不会参与候选搜索、确认取数或元数据刷新。</p>
        </el-form-item>
      ...
      <div>
        ...
        <el-button :loading="busy" :disabled="!form.enabled_scrapers.includes('anidb')" @click="refreshTitles">刷新标题库</el-button>
