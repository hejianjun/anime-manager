...
EXPECTED_OPERATIONS = {
    ...
    ("POST", "/api/anime/getchu-description-preview"),
    ("POST", "/api/anime/{anime_id}/getchu-description-detail"),
    ("POST", "/api/anime/{anime_id}/getchu-description-confirm"),
    ("POST", "/api/anime/{anime_id}/getchu-description-cancel"),
    ("POST", "/api/anime/{anime_id}/refresh"),
    ("POST", "/api/anime/{anime_id}/description-candidates"),
    ("POST", "/api/anime/{anime_id}/fill-description"),
